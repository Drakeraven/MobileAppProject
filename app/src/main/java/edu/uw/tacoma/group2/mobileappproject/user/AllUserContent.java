...
public class AllUserContent {
    ...
    private final static String RETRIEVE_ALL_USERS
     ...
     */
    public AllUserContent(JSONObject userJSON) {
        try {
        ...
        AllUserContent.AddUserTask task = new AllUserContent.AddUserTask();
    ...
    private String buildUserURL() {
        StringBuilder sb = new StringBuilder(RETRIEVE_ALL_USERS);
